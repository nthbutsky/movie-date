  ...
  return (
    <button
      ...
      className={clsx(
        ...
        { "bg-white dark:bg-black": !hasPoster },
      )}
    >
      <Image
        ...
        loading="lazy"
        className={clsx(
          "absolute left-0 top-0 z-0 size-full animate-fade-in",
          hasPoster
      ...
      <div className="absolute bottom-0 left-0 z-0 h-64 w-full bg-gradient-to-t from-zinc-900 transition-[bottom] duration-300 ease-in-out group-hover:-bottom-64"></div>
      <div
        className={clsx(
